<section>
    <header>
        ...
        <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
            {{ __('Assurez-vous que vous utilisez un mot de passe long contenant plusieurs caractères pour plus de sécurité.') }}
        </p>
    </header>
    ...
    <form method="post" action="{{ route('password.update') }}" class="mt-6 space-y-6">
        ...
        <div class="flex items-center gap-4">
            ...
            @if (session('status') === 'password-updated')
                ...
                >{{ __('Changement de mot de passe effectué avec succès. !') }}</p>
            @endif
        </div>
    </form>
</section>
